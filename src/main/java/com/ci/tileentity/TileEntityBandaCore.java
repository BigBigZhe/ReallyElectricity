...
public class TileEntityBandaCore extends TileEntity implements IInventory{

    private int count;
    private boolean temp;
    private ItemStack[] itemStacks;

    public TileEntityBandaCore(){
        count = 0;
        temp = false;
    ...
    public void readFromNBT(NBTTagCompound compound){
        ...
        this.temp = compound.getBoolean("Temp");
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound compound){
        ...
        compound.setBoolean("Temp", this.temp);
    ...
    public String getName() {
        return "container.tileentitybandacore.name";
    }
